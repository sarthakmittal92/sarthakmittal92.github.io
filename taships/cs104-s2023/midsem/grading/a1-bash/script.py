...
files = [['a.py','b.py','c.py','d.py'],
         ['a.py','b.py','c.py','d.py'],
         ['45092.39.509.py','a.py','b.py','best.py','c.py','d.py','prom.py'],
         ['45092.39.509.py','a.py','abhriami.jpeg.py','b.py','best.py','c.py','d.py','photo.jpeg.py','prom.py'],
         ['++_+_+__-=-==-===.eroiher.324r34-0+=--....py','++___++_+_+_+_.py','45092.39.509.py','a.py','abhriami.jpeg.py','b.py','best.py','c.py','d.py','dummy.pdf.py','photo.jpeg.py','prom.py']
         ]
...
for i in range(1,test_case_num+1):
    ...
    if(check_file==files[i-1]):
        ...
        check_file=list(map(lambda x:x.split('/')[-1],check_file))
        check_file.sort()
        if(check_file==files[i-1]):
            total+=1
            msg+=str('Partial credit for writing whole file path to log file')
        else:
            msg+=str('List of deleted files not correct')
